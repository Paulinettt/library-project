...
//books we are creating in our database
...
.catch(err => console.log(`An error occurred while seeding data in DB: ${err}`));



/* Book.create(books)  //create the books we have in this array in the database
  .then(booksFromDB => { //data received if request successful. Array of documents created
    console.log(`Created ${booksFromDB.length} books`); //the amount of books created
